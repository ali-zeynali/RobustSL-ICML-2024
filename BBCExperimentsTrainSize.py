...
trials = 10
__path_dir__ = "BBCExperimentTrainSize"
# categories = ['business', 'entertainment']
categories = ['entertainment']
train_sizes = [50, 100, 150, 200, 250, 400]
train_sizes = [int(10 * 410 / 100), int(20 * 410 / 100), int(30 * 410 / 100), int(40 * 410 / 100), int(50 * 410 / 100)]
    ...
    for train_size in train_sizes:
        ...
        if __do_test__:
            ...
            TestDS(balanced_tree, key_values, search_elements,
                   "{1}/BalBST_c{0}_t{2}.json".format(category, __path_dir__, train_size))
            ...
            TestDS(splayP, key_values, search_elements,
                   "{1}/SplayP_c{0}_t{2}.json".format(category, __path_dir__, train_size),
                   true_search=True,
                   __splay_cost__=True)

...
trials = 1
__path_dir__ = "RandomOrderDynamic"
for n in ns:
    for trial in range(trials):
        for idx, error in enumerate(errors):
            ...
            if __generate_data__:
                ...
                queries, frequencies = zipfi_dynamic_fixed(n, key_values, initial_elements, ranks, queries, error,
                                                           alpha)
                data = {}
            ...
            TestDS(rsl, queries,
                   "{2}/RSL_n{3}_e{0}_t{1}.json".format(int(error * 100), trial, __path_dir__, n))

            print("n: {1}, Trial: {0}, Making RSLP...".format(trial, n))
            p0 = 0.05
